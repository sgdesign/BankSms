...
public class RecyclerAdapterSubCategory extends RecyclerView.Adapter<RecyclerAdapterSubCategory.RecyclerViewHolder> {
    public Database db;
    ...
    public RecyclerAdapterSubCategory(ArrayList<StructData> names) {
        this.names = names;
    }

    @Override
    public RecyclerViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = G.inflater.from(viewGroup.getContext()).inflate(R.layout.item_layout_sub_category, viewGroup, false);
    ...
    public void onBindViewHolder(final RecyclerViewHolder RecyclerViewHolder, final int i) {
        ...
        RecyclerViewHolder.crd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(G.currentActivity, ActivitySms.class);
